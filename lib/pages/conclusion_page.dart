                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              "TourMate successfully transforms scattered travel experiences into one seamless, intelligent platform that empowers travelers to discover, plan, and enjoy their journeys like never before.",
                              style: GoogleFonts.inter(
                      ...
                      GridView.count(
                        ...
                        children: [
                          AchievementCard(
                            ...
                            description: "Created personas and user flows that prioritize traveler needs and preferences.",
                            color: const Color(0xFF6366F1),
                          ),
                          AchievementCard(
                            icon: LucideIcons.zap,
                            title: "Seamless Integration",
                            description: "Unified multiple travel services into one cohesive, intelligent platform.",
                            color: const Color(0xFF8B5CF6),
                          ),
                          AchievementCard(
                            icon: LucideIcons.shield,
                            title: "Secure & Reliable",
                            description: "Implemented Firebase authentication and secure API integrations.",
